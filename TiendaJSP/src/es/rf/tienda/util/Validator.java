...
public class Validator {
	...
	/**
	 * PatrÛn para validar el email, evitando puntos finales antes de la @ y que
	 ...
	 * DESCRIPCI·N:
	 *//**
		 * Esta funciÛn verifica que el DNI cumple el siguiente formato:
		 * xx.xxx.xxx-L <br>
	 ...
	 * cumpla con lasnormas de contraseÒa
	 * 
	 * @param password
	 *            string con la contraseÒa introducida
