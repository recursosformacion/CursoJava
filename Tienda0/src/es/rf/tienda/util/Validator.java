...
public class Validator {
	...
	/**
	 * Permite validar un teláfono, el cual debe contener de 10 a 20 dágitos
	 ...
	 *//**
		 ...
		 * dágitos y espacios. Mánimo aceptable son 10 dágitos.
		 * 
		 * @param phoneNumber
		 *            String con el námero de telefono de entre 10 y 20 dágitos.
	...
	public static boolean cumpleDNI(String dni) {
		...
		if (!dni.matches(DNI_PATTERN)){ //se comprueba que el formato del DNI se ajusta al patrón definido
			return false;
		}

		String dniNumerico = dni.substring(0, 
				dni.length()-2)
				.replace(".", "");
	 ...
	 * DESCRIPCIáN:
		 ...
		 *            int que indique longitud mánima.
		 * 
	...
	public static boolean cumpleLongitud(String texto, int longitudMinima, int longitudMaxima) {
		...
		return texto != null && 
				cumpleLongitudMin(texto, 
						longitudMinima) && 
				cumpleLongitudMax(texto, 
						longitudMaxima);
	...
	public static boolean esPasswordValida(String password){
		...
		return (password!=null && 
				...
				cumpleLongitud(password, PASSWORD_LONG_MIN, PASSWORD_LONG_MAX));
