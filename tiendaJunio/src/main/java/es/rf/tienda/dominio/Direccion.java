...
public class Direccion {
	...
	public void setNombre(String nombre) throws DomainException {
		if (Validator.isAlfanumeric(nombre) && Validator.cumpleLongitudMax(nombre, NOMBRE_LONG_MAX)
	...
	public void setDireccion(String direccion) throws DomainException {
		if (Validator.isAlfanumeric(direccion) && Validator.cumpleLongitudMax(direccion, DIRECCION_LONG_MAX)
