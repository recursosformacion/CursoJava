...
public class ErrorMessages {
	...
	/**
	 * The entered values in the password and the confirm password field are not
	 * the same
	 */
	...
	/**
	 * The email was not written using the appropriate format (i.e. <text>@
	 * <text>.<text>
	 */
	...
	/**
	 * The username being registered is already in use by another visitor
	 * account
	 */
	public final static String ERM_025 = "USERNAME already exists. Please register again with different USERNAME.";

	/**
	 * The visitor has already registered to attend an event and attempted to
	 * register again
	 */
	public final static String ERM_026 = "User already Registered for the EVENT!";

	/**
	 * The visitor is attempting to update their personal information with
