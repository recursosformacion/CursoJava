 ...
 * the License.
 */
package es.rf.cursoGWT.formulario.client.richText;
...
public class RichTextToolbar extends Composite {
	...
	public interface Images extends ClientBundle {
		...
		@Source("./icons/createLink.gif")	
		ImageResource createLink();

		@Source("./icons/hr.gif")
		ImageResource hr();

		@Source("./icons/indent.gif")
		ImageResource indent();

		@Source("./icons/insertImage.gif")
		ImageResource insertImage();

		@Source("./icons/italic.gif")
		ImageResource italic();

		@Source("./icons/justifyCenter.gif")
		ImageResource justifyCenter();

		@Source("./icons/justifyLeft.gif")
		ImageResource justifyLeft();

		@Source("./icons/justifyRight.gif")
		ImageResource justifyRight();

		@Source("./icons/ol.gif")
		ImageResource ol();

		@Source("./icons/outdent.gif")
		ImageResource outdent();

		@Source("./icons/removeFormat.gif")
		ImageResource removeFormat();

		@Source("./icons/removeLink.gif")
		ImageResource removeLink();

		@Source("./icons/strikeThrough.gif")
		ImageResource strikeThrough();

		@Source("./icons/subscript.gif")
		ImageResource subscript();

		@Source("./icons/superscript.gif")
		ImageResource superscript();

		@Source("./icons/ul.gif")
		ImageResource ul();

		@Source("./icons/underline.gif")
